  ...
  [6],
  {
    0: function (t, e, n) {
      ...
      function C(t) {
        return (
          (t.options && t._Ctor === t) ||
            (t.options ? ((t._Ctor = t), (t.extendOptions = t.options)) : ((t = l.a.extend(t))._Ctor = t),
                          ...
                          case 7:
                            throw (
                              ...
                              t.t0 &&
                                ...
                                ((f = Date.now()),
                                (!(l = parseInt(window.sessionStorage.getItem("nuxt-reload"))) || l + 6e4 < f) &&
                                  (window.sessionStorage.setItem("nuxt-reload", f), window.location.reload(!0))),
                              t.t0)
                            )
                          case 11:
                            return (
      ...
      function M(t, e) {
        return (function (t, e) {
          ...
          return function (e, r) {
            for (
              var path = "", data = e || {}, o = (r || {}).pretty ? z : encodeURIComponent, c = 0;
              c < t.length;
              c++
            ) {
              var f = t[c]
    ...
    123: function (t, e, n) {
      ...
      function d() {
        ...
        if (
          ("function" == typeof this.$options.fetchOnServer && (t = !1 !== this.$options.fetchOnServer.call(this)),
      ...
      e.a = {
        beforeCreate: function () {
          Object(c.m)(this) &&
            ...
            o.a.util.defineReactive(this, "$fetchState", { pending: !1, error: null, timestamp: Date.now() }),
    ...
    127: function (t, e, n) {
      ...
      n.r(e),
        function (t) {
          ...
          Object(v.a)(),
            o.a.__nuxt__fetch__mixin__ || (o.a.mixin(d.a), (o.a.__nuxt__fetch__mixin__ = !0)),
                  ...
                  function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          if (
                            ((this._routeChanged = Boolean(w.nuxt.err) || n.name !== e.name),
                            (this._paramChanged = !this._routeChanged && n.path !== e.path),
                            (this._queryChanged = !this._paramChanged && n.fullPath !== e.fullPath),
                            (this._diffQuery = this._queryChanged ? Object(l.j)(e.query, n.query) : []),
                      ...
                      switch ((t.prev = t.next)) {
                        ...
                        case 2:
                          return (
                            ...
                            (t.next = 8),
                            Object(l.t)(w, { route: e, from: n, next: m.bind(this) })
                          )
                        case 8:
                          if (
                        ...
                        case 20:
                          return (O = t.sent), (t.next = 23), T.call(this, x, w.context, O)
                        case 23:
                          if (!d) {
                            t.next = 25
                            break
                        ...
                        case 25:
                          return (
                            w.context.error({ statusCode: 404, message: "This page could not be found" }),
                            t.abrupt("return", o())
                          )
                        case 27:
                          return (
                        ...
                        case 36:
                          return (
                            "function" == typeof (j = x[0].options.layout) && (j = j(w.context)),
                            (t.next = 40),
                            this.loadLayout(j)
                          )
                        case 40:
                          return (j = t.sent), (t.next = 43), T.call(this, x, w.context, j)
                        case 43:
                          if (!d) {
                            t.next = 45
                            break
                        ...
                        case 45:
                          ...
                          return t.abrupt("return", o())
                        case 47:
                          ;(C = !0), (t.prev = 48), (P = y(x)), (t.prev = 50), P.s()
                        case 52:
                          if ((S = P.n()).done) {
                            t.next = 63
                            break
                                      ...
                                      return regeneratorRuntime.wrap(function (t) {
                                        for (;;)
                                          switch ((t.prev = t.next)) {
                                            case 0:
                                              if (
                                                ((r._path = Object(l.c)(e.matched[v[i]].path)(e.params)),
                                                (r._dataRefresh = !1),
                                                (o = r._path !== $[i]),
                                                D._routeChanged && o
                                                  ? (r._dataRefresh = !0)
                                                  : D._paramChanged && o
                                                  ? ((f = r.options.watchParam), (r._dataRefresh = !1 !== f))
                                                  : D._queryChanged &&
                                                    (!0 === (h = r.options.watchQuery)
                                                      ? (r._dataRefresh = !0)
                                                      : Array.isArray(h)
                                                      ? (r._dataRefresh = h.some(function (t) {
                                                          return D._diffQuery[t]
                                                        }))
                                                      : "function" == typeof h &&
                                                        (R || (R = Object(l.i)(e)),
                                                        (r._dataRefresh = h.apply(R[i], [e.query, n.query])))),
                                            ...
                                            case 6:
                                              return (
                                                ...
                                                m &&
                                                  ((_ =
                                                    D.isPreview || c
                                                      ? Object(l.q)(r.options.asyncData, w.context)
                                                ...
                                                D.isPreview ||
                                                  c ||
                                                  d.push(
                                                    D.fetchPayload(e.path).catch(function (t) {
                                                      return null
                                                    })
                                                  ),
                                                y &&
                                                  (((p = r.options.fetch(w.context)) &&
                        ...
                        case 82:
                          d || (this.$loading.finish && !this.$loading.manual && this.$loading.finish(), o()),
                            (t.next = 99)
                          break
                        case 85:
          ...
          function D(t, n) {
            Object(l.e)(t, function (t, n, r, c) {
              return (
                "object" !== Object(e.a)(t) || t.options || (((t = o.a.extend(t))._Ctor = t), (r.components[c] = t)), t
              )
            })
          }
          function L(t) {
                ...
                return regeneratorRuntime.wrap(
                  function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          if (((w = e.app), (_ = e.router), e.store, (n = new o.a(w)), O.data || !O.serverRendered)) {
                            t.next = 14
                            break
                          }
                          return (t.prev = 5), (t.next = 8), n.fetchPayload(O.routePath || n.context.route.path)
                        case 8:
                        ...
                        case 14:
                          return (c = O.layout || "default"), (t.next = 17), n.loadLayout(c)
                        case 17:
                          return (
                            n.setLayout(c),
                            (f = function () {
                        ...
                        case 30:
                          return (
                            (d = function () {
                              D(_.currentRoute, _.currentRoute), L.call(n, _.currentRoute), I(n), f()
                            }),
                            (t.next = 33),
                            new Promise(function (t) {
                        ...
                        case 33:
                          A.call(n, _.currentRoute, _.currentRoute, function (path) {
                            if (path) {
    ...
    19: function (t, e, n) {
      ...
      function $(t) {
        ...
        if (y) {
          var o = l++
          ;(r = f || (f = _())), (e = C.bind(null, r, o, !1)), (n = C.bind(null, r, o, !0))
        } else
          (r = _()),
            (e = k.bind(null, r)),
            (n = function () {
    ...
    21: function (t, e, n) {
      ...
      var k = {
              ...
              n("div", { staticClass: "error" }, [
                ...
                404 === t.statusCode
                  ? n(
                      ...
                      [
                        void 0 === t.$route
                          ? n("a", { staticClass: "error-link", attrs: { href: "/" } })
                          : n("NuxtLink", { staticClass: "error-link", attrs: { to: "/" } }, [
          ...
          [
            function () {
              ...
              return n("div", { staticClass: "logo" }, [
                n("a", { attrs: { href: "https://nuxtjs.org", target: "_blank", rel: "noopener" } }, [t._v("Nuxt")])
              ])
            }
          ],
          !1,
        ...
        L = (n(169), Object(R.a)(D, undefined, undefined, !1, null, null, null).exports),
        I = (n(171), n(125))
      function M(t, e) {
        var n = ("undefined" != typeof Symbol && t[Symbol.iterator]) || t["@@iterator"]
        if (!n) {
        ...
        K = {
          ...
          methods: {
                            ...
                            return (
                              ...
                              (r = n.map(function (e) {
                                ...
                                if (
                                  ...
                                  var n,
                                    r = M(Object(w.f)(e.$vnode.componentInstance))
                                  try {
                                    for (r.s(); !(n = r.n()).done; ) {
            ...
            setLayout: function (t) {
              return (
                (t && B["_" + t]) || (t = "default"), (this.layoutName = t), (this.layout = B["_" + t]), this.layout
              )
            },
                        ...
                        case 0:
                          return e.abrupt(
                            ...
                            window.__NUXT_IMPORT__(
                              "manifest.js",
                              Object(x.d)(Object(w.v)(t.getStaticAssetsPath(), "manifest.js"))
                            )
                          )
                        case 1:
                        case "end":
                    ...
                    function (r) {
                      for (;;)
                        switch ((r.prev = r.next)) {
                          case 0:
                            return (path = Object(x.a)(n.getRoutePath(t))), (r.next = 3), n.fetchStaticManifest()
                          case 3:
                          ...
                          case 7:
                            return (
                              (o = Object(w.v)(n.getStaticAssetsPath(t), "payload.js")),
                              (r.prev = 8),
                              (r.next = 11),
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (
                      (m = function (t, e) {
                        ...
                        ;(l[(t = "$" + t)] = e), l.context[t] || (l.context[t] = e), (f[t] = l[t])
                  ...
                  case 4:
                    return (
                      ...
                      (l = H(
                        {
                          head: {
                            title: "Ecommerce template built with Vue.js and Nuxt.js",
                            meta: [
                              { charset: "utf-8" },
                              { name: "viewport", content: "width=device-width, initial-scale=1" },
                              {
                                hid: "description",
                                name: "description",
                                content: "Ecommerce template built with Vue.js and Nuxt.js"
                              },
                          ...
                          nuxt: {
                            ...
                            dateErr: null,
                            error: function (t) {
                              ;(t = t || null), (l.context._errored = Boolean(t)), (t = t ? Object(w.p)(t) : null)
                              var n = l.nuxt
                              return (
                      ...
                      e
                        ...
                        : ((path = Object(w.g)(o.options.base, o.options.mode)), (d = o.resolve(path).route)),
                      (t.next = 14),
                      Object(w.t)(l, {
                        store: f,
                        route: d,
                  ...
                  case 14:
                    return (
                      m("config", n),
                      window.__NUXT__ && window.__NUXT__.state && f.replaceState(window.__NUXT__.state),
                      ...
                      new Promise(function (t, e) {
                        if (!o.resolve(l.context.route.fullPath).route.matched.length) return t()
          ...
          return n._isMounted
            ...
            : (n.$once("hook:mounted", function () {
              ...
              o.placeholderTag && (o.placeholder || l)
                ? t(o.placeholderTag, { class: ["no-ssr-placeholder"] }, o.placeholder || l)
                : f.length > 0
                ? f.map(function () {
                    return t(!1)
                  })
    ...
    68: function (t, e, n) {
      "use strict"
      n(35), n(26), n(57), n(58), n(17), n(37), n(16), n(30), n(43), n(47), n(48)
      var r = n(1)
      function o(t, e) {
        var n = ("undefined" != typeof Symbol && t[Symbol.iterator]) || t["@@iterator"]
        if (!n) {
        ...
        render: function (t, e) {
          ...
          return n._isMounted
            ...
            : (n.$once("hook:mounted", function () {
              ...
              o.placeholderTag && (o.placeholder || l)
                ? t(o.placeholderTag, { class: ["client-only-placeholder"] }, o.placeholder || l)
                : f.length > 0
                ? f.map(function () {
                    return t(!1)
                  })
